...
@EntityScan(basePackages = "com.example.persistence.model")
public class PersistenceTestConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        //در اینجا داریم مسیر entity ها را مشخص میکنیم اگر مسیر را اشتباه بدهیم با خطای creation exception error مواجه میشویم
        //بخاطر این است که نمیتواند entity ها را پیدا کند
