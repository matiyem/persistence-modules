...
@Audited//برای track کردن و log کردن عملیات که بر روی این entity انجام میشود
...
public class Bar implements Serializable {
    ...
    //وقتی یک collectionداریم برای sort کرد از orderBy استفاده میکنیم
    //این مرتب سازی براساس فیلد تیبل انجام میشود نه براساس attribute
    //One thing to keep in mind is that it is not possible to to sort Lists as was the case with JPA
    //“Hibernate currently ignores @OrderBy on @ElementCollection on e.g. List<String>.
    // The order of elements is as returned by the database, undefined.”
    @OrderBy(clause = "NAME DESC")
    //از این annotation زیر میتوان برای یک column استفاده کرد بجای استفاده بر روی entity
//     @NotAudited
