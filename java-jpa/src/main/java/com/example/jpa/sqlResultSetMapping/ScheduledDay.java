...
@SqlResultSetMappings(value = {
        @SqlResultSetMapping(name = "ScheduleResult",
                classes = { @ConstructorResult(targetClass = com.example.jpa.sqlResultSetMapping.ScheduledDay.class,
        ...
        @SqlResultSetMapping(name = "EmployeeScheduleResults",
                entities = { @EntityResult(entityClass =com.example.jpa.sqlResultSetMapping.Employee.class),
                        @EntityResult(entityClass = com.example.jpa.sqlResultSetMapping.ScheduledDay.class)
                }) })
