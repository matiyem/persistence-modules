...
import com.example.partialUpdate.PartialUpdateApplication;
import com.example.partialUpdate.service.CustomerService;
...
public class PartialUpdateUnitTest {
    ...
    public void givenCustomer_whenUpdate_thenSuccess() {
        ...
        myCustomer = service.updateCustomer(myCustomer.getId(), "+00");
