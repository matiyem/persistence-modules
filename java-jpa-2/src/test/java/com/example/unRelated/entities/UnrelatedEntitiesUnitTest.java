package com.example.unRelated.entities;
...
public class UnrelatedEntitiesUnitTest {
    ...
    public void givenCocktailsWithRecipe_whenQuerying_thenTheExpectedCocktailsReturned() {
        ...
        // QueryDSL
        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .join(com.example.unRelated.entities.QCocktail.cocktail.recipe)
          .fetchOne();
        verifyResult(mojito, cocktail);

        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .join(com.example.unRelated.entities.QRecipe.recipe)
          .on(com.example.unRelated.entities.QCocktail.cocktail.name.eq(com.example.unRelated.entities.QRecipe.recipe.cocktail))
          .fetchOne();
        verifyResult(mojito, cocktail);
    }
    ...
    public void givenCocktailsWithoutRecipe_whenQuerying_thenTheExpectedCocktailsReturned() {
        ...
        com.example.unRelated.entities.QRecipe recipe = new com.example.unRelated.entities.QRecipe("alias");
        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .leftJoin(com.example.unRelated.entities.QCocktail.cocktail.recipe, recipe)
          .where(recipe.isNull())
          .fetchOne();
        verifyResult(ginTonic, cocktail);

        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .leftJoin(com.example.unRelated.entities.QRecipe.recipe)
          .on(com.example.unRelated.entities.QCocktail.cocktail.name.eq(com.example.unRelated.entities.QRecipe.recipe.cocktail))
          .where(com.example.unRelated.entities.QRecipe.recipe.isNull())
          .fetchOne();
        verifyResult(ginTonic, cocktail);
    }
    ...
    public void givenCocktailsWithMultipleRecipes_whenQuerying_thenTheExpectedCocktailsReturned() {
        ...
        // QueryDSL
        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .join(com.example.unRelated.entities.QCocktail.cocktail.recipeList)
          .fetchOne();
        verifyResult(mojito, cocktail);

        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .join(com.example.unRelated.entities.QMultipleRecipe.multipleRecipe)
          .on(com.example.unRelated.entities.QCocktail.cocktail.name.eq(com.example.unRelated.entities.QMultipleRecipe.multipleRecipe.cocktail))
          .fetchOne();
        verifyResult(mojito, cocktail);
    }
    ...
    public void givenCocktailsWithoutMultipleRecipes_whenQuerying_thenTheExpectedCocktailsReturned() {
        ...
        // QueryDSL
        com.example.unRelated.entities.QMultipleRecipe multipleRecipe = new com.example.unRelated.entities.QMultipleRecipe("alias");
        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .leftJoin(com.example.unRelated.entities.QCocktail.cocktail.recipeList, multipleRecipe)
          .where(multipleRecipe.isNull())
          .fetchOne();
        verifyResult(ginTonic, cocktail);

        cocktail = new JPAQuery<Cocktail>(entityManager).from(com.example.unRelated.entities.QCocktail.cocktail)
          .leftJoin(com.example.unRelated.entities.QMultipleRecipe.multipleRecipe)
          .on(com.example.unRelated.entities.QCocktail.cocktail.name.eq(com.example.unRelated.entities.QMultipleRecipe.multipleRecipe.cocktail))
          .where(com.example.unRelated.entities.QMultipleRecipe.multipleRecipe.isNull())
          .fetchOne();
        verifyResult(ginTonic, cocktail);
    }
    ...
    public void givenMultipleRecipesWithCocktails_whenQuerying_thenTheExpectedMultipleRecipesReturned() {
        ...
        // QueryDSL
        com.example.unRelated.entities.QCocktail cocktail = com.example.unRelated.entities.QCocktail.cocktail;
        com.example.unRelated.entities.QMultipleRecipe multipleRecipe = com.example.unRelated.entities.QMultipleRecipe.multipleRecipe;
